...
public class World {
    ...
    private void handleCollision() {
        ...
        for (int i = 0; i < 2; i++) {
            ...
            GameObjects.Line line = ball.isColliding(paddles[i].getBox(0));
            if (line != null) {
                // repell normally
    ...
    private void movePaddles() {
        ...
        // update GameObjects.Paddle positions
    ...
    public void keyPressed(char key) {
        switch (key) {
            case KeyConstants.LEFT_UP_CHAR:
                ...
                System.out.println("Left GameObjects.Paddle moving up");
                break;
            case KeyConstants.LEFT_DOWN_CHAR:
                keys[KeyConstants.LEFT_DOWN].presDown();
                System.out.println("Left GameObjects.Paddle moving down");
                break;
            case KeyConstants.RIGHT_UP_CHAR:
                keys[KeyConstants.RIGHT_UP].presDown();
                System.out.println("Right GameObjects.Paddle moving up");
                break;
            case KeyConstants.RIGHT_DOWN_CHAR:
                keys[KeyConstants.RIGHT_DOWN].presDown();
                System.out.println("Rigth GameObjects.Paddle moving down");
        }
    }
